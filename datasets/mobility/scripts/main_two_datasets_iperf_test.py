...
def work_with_gnb(exp_ctx: ctx.ExpContext):
    exp_ctx.file_path=f"./Data/IPERF_DL_TEST_2/gnb/{exp_ctx.CURRENT_GNB_NAME}/ue_get/"
...
if __name__ == "__main__":
    ...
    timestamps_exp1=get_timestamp_list("data/IPERF_DL_TEST_2/gnb/202/ue_get")
    ...
    for timestamp in    timestamps_exp1:
        ...
        exp_ctx.TEST_NAME="IPERF_DL_TEST_2_GNB_202"
    ...
    for timestamp in    timestamps_exp1:
        ...
        exp_ctx.TEST_NAME="IPERF_DL_TEST_2_GNB_203"
        exp_ctx=work_with_gnb(exp_ctx)
        exp_ctx=create_dataset_entry(exp_ctx)
